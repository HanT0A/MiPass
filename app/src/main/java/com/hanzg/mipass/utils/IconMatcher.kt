...
object IconMatcher {
    ...
    private val brandIconMap: Map<String, String> = mapOf(
        ...
        // 国际主流（含中文别名）
        "google" to "ic_brand_google", "谷歌" to "ic_brand_google",
        "gmail" to "ic_brand_gmail",
        "youtube" to "ic_brand_youtube", "油管" to "ic_brand_youtube",
        "facebook" to "ic_brand_facebook", "脸书" to "ic_brand_facebook", "fb" to "ic_brand_facebook",
        "instagram" to "ic_brand_instagram", "ins" to "ic_brand_instagram",
        "twitter" to "ic_brand_twitter", "x" to "ic_brand_twitter", "推特" to "ic_brand_twitter",
        "github" to "ic_brand_github",
        "apple" to "ic_brand_apple", "苹果" to "ic_brand_apple",
        "netflix" to "ic_brand_netflix", "奈飞" to "ic_brand_netflix",
        "spotify" to "ic_brand_spotify",
        "discord" to "ic_brand_discord",
        "telegram" to "ic_brand_telegram", "tg" to "ic_brand_telegram", "电报" to "ic_brand_telegram",
        ...
        "airbnb" to "ic_brand_airbnb", "爱彼迎" to "ic_brand_airbnb",
        "uber" to "ic_brand_uber", "优步" to "ic_brand_uber",
